...
class DataTables
{
     ...
     * @return mixed
     */
    public function select($columns, $backtick_protect = TRUE, $set = NULL)
    {
    ...
    private function get_filtering()
    {
        ...
        $sSearch = $this->ci->db->escape_like_str(trim($searchValue));
    ...
    private function produce_output($output, $charset)
    {
        ...
        if ($output == 'json') {
            ...
            (
                ...
                'csrf_token_value' => $this->ci->security->get_csrf_hash(),
            );
