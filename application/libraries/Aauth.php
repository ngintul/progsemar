...
class Aauth
{
    ...
    public function update_login_attempts($email)
    {
        ...
        if ($data['login_attempts'] > $this->CI->config->item('app_default_max_login_attempts')) {
            return FALSE;
        } else {
            return TRUE;
        }
     ...
     * @param string $sponsor User's name
     * @return int|bool False if create fails or returns user id if successful
     */
    public function create_user($email, $pass, $name, $username, $phone)
    {
    ...
    public function user_exsist_by_username($username)
    {
    ...
    public function list_perms_array()
    {
